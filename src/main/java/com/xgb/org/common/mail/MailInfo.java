package com.xgb.org.common.mail;
...
public class MailInfo {
	...
	public String toString() {
		return "MailInfo [content=" + content + ", errorCc=" + errorCc
				+ ", errorTo=" + errorTo + ", mailHost=" + mailHost
				+ ", mailPort=" + mailPort + ", notifyCc=" + notifyCc
				+ ", notifyTo=" + notifyTo + ", password=" + password
				+ ", subject=" + subject + ", username=" + username
				+ ", warningCc=" + warningCc + ", warningTo=" + warningTo + "]";
	}
