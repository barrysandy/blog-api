...
public class MailSender {
    ...
    private static final String USERNAME = "751544247@qq.com";
    private static final String PASSWORD = "lpvkucohirembbbj";
     ...
     * @return
     */
    public MailInfo getMailInfo(String to,String title,String content) {
